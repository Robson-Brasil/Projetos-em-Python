...
def falar(audio):
    ...
    time.sleep(1.0)  # Adiciona uma pausa de 0,5 segundos após cada fala
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for topic in relay_topics:    
            ...
            elif f"temperatura {alias}" in command:
                client.publish(topic, str_temp_data)
                client.publish(topic, str_hum_data)
